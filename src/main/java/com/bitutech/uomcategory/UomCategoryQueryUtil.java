...
public class UomCategoryQueryUtil {
	...
	public static final String EDIT_UOM_CATEGORY= "select uomcategory_code as uomCode,uomcategory_name as categoryName,uomcategory_desc as categoryDesp from uom_category where uomcategory_code =?";
	public static final String SELECT_UOM_CATEGORY = "select uomcategory_name as categoryName,uomcategory_desc as categoryDesp from uom_category where uomcategory_code=?";

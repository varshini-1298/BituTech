...
public class DesignationMasterQueryUtil {
	...
	public static final String SELECT_DESIGNATION_MASTER = "select desgn_code as desgnCode,desgn_name as designationName,desgn_desc as remarks from designation where desgn_code=?";
	public static final String UPDATE_DESIGNATION_MASTER = "update designation set desgn_name=:designationName,desgn_desc=:remarks,modified_dt=now() where desgn_code=:desgnCode";
